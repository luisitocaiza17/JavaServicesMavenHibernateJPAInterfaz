...
function Loading_Hide(p?: boolean) {
    if (p == true) {
...
head.load("../libs/kendo-ui/js/jquery.min.js", "../Config.js", function () {
    ...
    if ((filename != 'Login.html' && filename != "RecuperarClave.html" && filename != "ActivacionUsuario.html") &&
        ...
        head.load("../libs/kendo-ui/js/kendo.all.min.js",
            "../libs/kendo-ui/js/cultures/kendo.culture.es-EC.min.js",
            "../libs/kendo-ui/js/messages/kendo.messages.es-EC.min.js",
            "../Scripts/Configure/Proxy.js",
            "../libs/filesaver/FileSaver.js",
            "../libs/cryptojs/src/core.js",
            "../libs/cryptojs/src/enc-base64.js",
            "../libs/cryptojs/src/md5.js",
            "../libs/cryptojs/src/evpkdf.js",
            "../libs/cryptojs/src/cipher-core.js",
            "../libs/cryptojs/src/aes.js",
            "../libs/slick/slick/slick.min.js",
            "../Styles/Site.css",
            '../libs/kendo-ui/styles/kendo.common-material.min.css',
            '../libs/kendo-ui/styles/kendo.material.min.css',
            '../libs/kendo-ui/styles/kendo.material.mobile.min.css',
            '//maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css',
            "../libs/kendo-ui/js/jszip.min.js",
            function () {
...
function serializeGETpars(obj): string {
    var str = [];
    for (var p in obj)
...
function getInternationalFomat(date: Date) {
    return '' + date.getFullYear() + '-' + (date.getUTCMonth() + 1) + '-' + date.getUTCDate();
}

function getFormattedDateymd(date: Date): string {
...
function Confirmation(text: string, fOk, fCancel) {
    ConfirmationConf("", text, "Aceptar", "Cancelar", fOk, fCancel);
}

function ConfirmationConf(header:string, text: string, OkText:string, CancelText:string, fOk, fCancel) {
    var nid = makeid();
